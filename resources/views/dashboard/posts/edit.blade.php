    ...
    <div class="row" style="min-height: 100vh;">
        <div class="col-lg-8">
            <form action="/dashboard/posts/{{ $post->slug }}" method="POST" enctype="multipart/form-data">
                @method('PATCH')
                @csrf
                <input type="hidden" name="thumb_" value="{{ $post->thumbnail }}">
                <div class=" mb-3">
                    ...
                    <textarea rows="1" class="form-control @error('title') is-invalid @enderror" id="title"
                        placeholder="Some Interesting Title..." name="title" autocomplete="off" autofocus>{{ old('title', $post->title) }}</textarea>
                ...
                <div class="input-group mb-3">
                    <input type="text"
                        ...
                        value="{{ $post->slug }}" placeholder="Auto Slug Is In Action!" name="slug" readonly>
                ...
                <div class="mb-3">
                    ...
                    <img id="previewImg" src="{{ $post->thumbnail ? asset('storage/' . $post->thumbnail) : '' }}"
                        width="200" class="d-block mb-2">
...
@push('foot')
    ...
    <script>
        ...
        $('#preview').click(function() {
            ...
            <p class="blog-post-meta">{{ date('d M Y', strtotime($post->created_at)) }} (Edited at ${strDate})</p>\n
            <div class="pb-2">
