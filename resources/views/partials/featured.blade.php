        ...
        <div class="carousel-inner rounded">
            <div class="carousel-item active">
                <a href="/post/{{ $posts[0]->slug }}">
                    <img src="https://source.unsplash.com/1200x500?{{ $posts[0]->category->name }}"
                    ...
                    <div class="carousel-caption d-none d-md-block rounded" style="background-color: rgba(0, 0, 0, .2)">
                        <h5>{{ $posts[0]->title }}</h5>
                        <p>{{ Str::limit($posts[0]->excerpt, 120, '...') }}</p>
                    </div>
                </a>
            </div>
            @if ($posts->count() > 6)
    ...
    <div class="col-md-6">
        <div class="row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative featured-posts"
            ...
            <div class="col p-4 d-flex flex-column position-static text-light" style="background: rgba(0, 0, 0, .2)">
                ...
                <h3 class="mb-0">{{ Str::limit($posts[1]->title, 20, '..') }}</h3>
                ...
                <p class="card-text mb-auto">{{ Str::limit($posts[1]->excerpt, 100, '...') }}</p>
    ...
    <div class="col-md-6">
        <div class="row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative featured-posts"
            ...
            <div class="col p-4 d-flex flex-column position-static text-light" style="background: rgba(0, 0, 0, .2)">
                ...
                <h3 class="mb-0">{{ Str::limit($posts[2]->title, 20, '..') }}</h3>
                ...
                <p class="card-text mb-auto">{{ Str::limit($posts[2]->excerpt, 100, '...') }}</p>
